...
begin
  ...
  {$IFDEF DLL}deh_actions[240].decl := 'A_Playsound()';{$ENDIF}
  deh_actions[241].action.acp1 := @A_RandomSound;
  deh_actions[241].name := strupper('RandomSound');
  {$IFDEF DLL}deh_actions[241].decl := 'A_RandomSound()';{$ENDIF}
  ...
  {$IFDEF DLL}deh_actions[243].decl := 'A_Jump()';{$ENDIF}
  deh_actions[244].action.acp1 := @A_CustomMissile;
  deh_actions[244].name := strupper('CustomMissile');
  {$IFDEF DLL}deh_actions[244].decl := 'A_CustomMissile()';{$ENDIF}
  ...
  {$IFDEF DLL}deh_actions[252].decl := 'A_SetTranslucent()';{$ENDIF}
  ...
  {$IFDEF DLL}deh_actions[268].decl := 'A_PlayWeaponsound()';{$ENDIF}
  ...
  {$IFDEF DLL}deh_actions[277].decl := 'A_BulletAttack()';{$ENDIF}
  ...
  {$IFDEF DLL}deh_actions[285].decl := 'A_SpawnItemEx()';{$ENDIF}
  deh_actions[286].action.acp1 := @A_RandomMissile;
  deh_actions[286].name := strupper('RandomMissile');
  {$IFDEF DLL}deh_actions[286].decl := 'A_RandomMissile()';{$ENDIF}
  ...
  {$IFDEF DLL}deh_actions[314].decl := 'A_RunScript()';{$ENDIF}
  ...
  {$IFDEF DLL}deh_actions[322].decl := 'A_TargetDropItem()';{$ENDIF}
  ...
  {$IFDEF DLL}deh_actions[324].decl := 'A_SetDropItem()';{$ENDIF}
