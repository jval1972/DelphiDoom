...
procedure R_DrawBatchColumn7(const walls: Pbatchwallrenderinfo8_t);
var
  w: Pwallrenderinfo8_t;
  ypos: integer;
  dest: PByte;
...
begin
  ...
  begin
    ...
    buf2.byte1 := dc_colormap5[dc_source5[(LongWord(frac5) shr FRACBITS) and 127]];
    inc(frac5, fracstep5);

    buf2.byte2 := dc_colormap6[dc_source6[(LongWord(frac6) shr FRACBITS) and 127]];
    inc(frac6, fracstep6);
...
procedure R_DrawBatchColumn6(const walls: Pbatchwallrenderinfo8_t);
var
  w: Pwallrenderinfo8_t;
  ypos: integer;
  dest: PByte;
...
procedure R_DrawBatchColumn5(const walls: Pbatchwallrenderinfo8_t);
var
  w: Pwallrenderinfo8_t;
  ypos: integer;
  dest: PByte;
...
procedure R_DrawBatchColumn3(const walls: Pbatchwallrenderinfo8_t);
var
  w: Pwallrenderinfo8_t;
  ypos: integer;
  dest: PByte;
...
procedure R_DrawBatchColumn2(const walls: Pbatchwallrenderinfo8_t);
var
  w: Pwallrenderinfo8_t;
  ypos: integer;
  dest: PByte;
