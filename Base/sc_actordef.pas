...
var
  ...
  begin
    ...
    if acheck[1] = 'M' then
    begin
      if Pos1('MF6_EX_', acheck) then
        acheck := Copy(acheck, 8, length(acheck) - 7)
      else if Pos1('MF5_EX_', acheck) then
        acheck := Copy(acheck, 8, length(acheck) - 7)
      else if Pos1('MF4_EX_', acheck) then
        acheck := Copy(acheck, 8, length(acheck) - 7)
  ...
  begin
    ...
    begin
      ...
      if Pos1('MF5_EX_', flag) then
        flag := Copy(flag, 8, length(flag) - 7)
      else if Pos1('MF4_EX_', flag) then
        flag := Copy(flag, 8, length(flag) - 7)
      else if Pos1('MF3_EX_', flag) then
        flag := Copy(flag, 8, length(flag) - 7)
      else if Pos1('MF2_EX_', flag) then
  ...
  begin
    ...
    begin
      ...
      if Pos1('MF6_EX_', flag) then
        flag := Copy(flag, 8, length(flag) - 7)
      else if Pos1('MF5_EX_', flag) then
        flag := Copy(flag, 8, length(flag) - 7)
      else if Pos1('MF4_EX_', flag) then
        flag := Copy(flag, 8, length(flag) - 7)
      else if Pos1('MF3_EX_', flag) then
  ...
  begin
    ...
    begin
      s_token := strupper(sc._String);
      if s_token = 'BRIGHT' then
        stmp := 'BRIGHT ' + SC_RemoveLineComments(sc.GetStringEOLUnChanged)
      else if s_token = 'FAST' then
        stmp := 'FAST ' + SC_RemoveLineComments(sc.GetStringEOLUnChanged)
      else
      begin
  ...
  begin
    ...
    begin
      ...
      repeat
        ...
        else if (g_token = 'MELEERANGE') then
        begin
          sc.GetInteger;
        ...
        else if (g_token = 'MAXSTEPHEIGHT') then
        begin
          sc.GetFloat;
        ...
        else if (g_token = 'MAXDROPOFFHEIGHT') then
        begin
          sc.GetFloat;
        ...
        else if (g_token = 'GIBHEALTH') then
        begin
          sc.GetInteger;
        ...
        else if (g_token = 'MAXTARGETRANGE') then
        begin
          sc.GetInteger;
        ...
        else if (g_token = 'WEAVEINDEXXY') then
        begin
          sc.GetInteger;
        ...
        else if (g_token = 'WEAVEINDEXZ') then
        begin
          sc.GetInteger;
        ...
        else if (g_token = 'BLOODCOLOR') then
        begin
          sc.GetString;
        ...
        else if (g_token = 'TRANSLATION') then
        begin
          sc.GetString;
        ...
        else if (g_token = 'MINMISSILECHANCE') then
        begin
          sc.GetInteger;
        ...
        else if (g_token = 'FLOATSPEED') then
        begin
          sc.GetInteger;
          mobj.floatspeed := sc._Integer;
          sc.GetString;
        end
        else if (g_token = 'NORMALSPEED') then
        begin
          sc.GetInteger;
          mobj.normalspeed := sc._Integer;
          sc.GetString;
        end
        else if (g_token = 'FASTSPEED') then
        begin
          sc.GetInteger;
          mobj.normalspeed := sc._Integer;
          sc.GetString;
        end
        else if (g_token = 'OBITUARY') then
        begin
          sc.GetString;
          mobj.obituary := sc._String;
          sc.GetString;
        end
        else if (g_token = 'HITOBITUARY') then
        begin
          sc.GetString;
        ...
        else if (g_token = 'MELEETHRESHOLD') then
        begin
          sc.GetInteger;
