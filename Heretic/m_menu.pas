...
begin
  ...
  ppos := M_WriteText4(ControlsDef.x, ControlsDef.y + ControlsDef.itemheight * Ord(ctrl_autorun), 'Always run: ');
  M_WriteWhiteText4(ppos.x, ppos.y, mautorunstrings[autorunmode]);
...
//KeyBindingsMenu4
  ...
  begin
    pmi.status := 1;
    pmi.name := '!' + KeyBindingsInfo[Ord(kb_am_gobigkey) + i].text + ': ';
    pmi.cmd := '';
...
//KeyBindingsDef4
  ...
  KeyBindingsDef4.rightmenu := nil; // right menu
  KeyBindingsDef4.righttext := '';
