...
begin
  ...
  {$IFDEF DLL}deh_actions[139].decl := 'A_Playsound()';{$ENDIF}
  deh_actions[140].action.acp1 := @A_RandomSound;
  deh_actions[140].name := strupper('RandomSound');
  {$IFDEF DLL}deh_actions[140].decl := 'A_RandomSound()';{$ENDIF}
  ...
  {$IFDEF DLL}deh_actions[142].decl := 'A_Jump()';{$ENDIF}
  deh_actions[143].action.acp1 := @A_CustomMissile;
  deh_actions[143].name := strupper('CustomMissile');
  {$IFDEF DLL}deh_actions[143].decl := 'A_CustomMissile()';{$ENDIF}
  ...
  {$IFDEF DLL}deh_actions[151].decl := 'A_SetTranslucent()';{$ENDIF}
  ...
  {$IFDEF DLL}deh_actions[167].decl := 'A_PlayWeaponsound()';{$ENDIF}
  ...
  {$IFDEF DLL}deh_actions[176].decl := 'A_BulletAttack()';{$ENDIF}
  ...
  {$IFDEF DLL}deh_actions[184].decl := 'A_SpawnItemEx()';{$ENDIF}
  deh_actions[185].action.acp1 := @A_RandomMissile;
  deh_actions[185].name := strupper('RandomMissile');
  {$IFDEF DLL}deh_actions[185].decl := 'A_RandomMissile()';{$ENDIF}
  ...
  {$IFDEF DLL}deh_actions[212].decl := 'A_RunScript()';{$ENDIF}
  ...
  {$IFDEF DLL}deh_actions[218].decl := 'A_TargetDropItem()';{$ENDIF}
  ...
  {$IFDEF DLL}deh_actions[220].decl := 'A_SetDropItem()';{$ENDIF}
