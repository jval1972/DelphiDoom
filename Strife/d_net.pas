    ...
    begin
      ...
      begin
        if netbuffer.player <> VERSION then
          I_Error('D_ArbitrateNetStart(): Different STRIFE versions cannot play a net game!');
...
begin
  ...
  printf(' startskill %d  deathmatch: %d  startmap: %d'#13#10,
    [Ord(startskill), deathmatch, startmap]);
