...
begin
  ...
  deh_actions[88].decl := 'A_Playsound(sound)';
  deh_actions[89].action.acp1 := @A_RandomSound;
  deh_actions[89].name := strupper('RandomSound');
  deh_actions[89].decl := 'A_RandomSound(sound1, sound2, ...)';
  ...
  deh_actions[91].decl := 'A_Jump(propability, offset)';
  deh_actions[92].action.acp1 := @A_CustomMissile;
  deh_actions[92].name := strupper('CustomMissile');
  deh_actions[92].decl := 'A_CustomMissile(missiletype, [height], [offset], [angle], [aimmode], [pitch])';
  ...
  deh_actions[100].decl := 'A_SetTranslucent()';
  ...
  deh_actions[116].decl := 'A_PlayWeaponsound()';
  ...
  deh_actions[125].decl := 'A_BulletAttack()';
