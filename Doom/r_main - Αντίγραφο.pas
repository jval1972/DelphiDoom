...
{  projection := (centerxfrac);
  ...
  wide_centerx := Round(centerx * aspect);
  projection := wide_centerx * FRACUNIT;
  projectiony := (((SCREENHEIGHT * centerx * 320) div 200) div SCREENWIDTH * FRACUNIT); // JVAL for correct aspect
...
{$ENDIF}
  ...
  pspriteyscale := ((((SCREENHEIGHT * viewwidth) div SCREENWIDTH) * FRACUNIT) div 200);  // player sprite aspect
