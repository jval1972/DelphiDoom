...
type
  TScriptPrintPreviewDlg = class(TForm)
...
var
  ScriptPrintPreviewDlg: TScriptPrintPreviewDlg;

implementation

{$R *.DFM}

procedure TScriptPrintPreviewDlg.FormShow(Sender: TObject);
begin
...
procedure TScriptPrintPreviewDlg.FirstCmdExecute(Sender: TObject);
begin
  SynEditPrintPreview.FirstPage;
end;

procedure TScriptPrintPreviewDlg.PrevCmdExecute(Sender: TObject);
begin
  SynEditPrintPreview.PreviousPage;
end;

procedure TScriptPrintPreviewDlg.NextCmdExecute(Sender: TObject);
begin
  SynEditPrintPreview.NextPage;
end;

procedure TScriptPrintPreviewDlg.LastCmdExecute(Sender: TObject);
begin
  SynEditPrintPreview.LastPage;
end;

procedure TScriptPrintPreviewDlg.ZoomCmdExecute(Sender: TObject);
begin
  SynEditPrintPreview.ScaleMode := pscWholePage;
end;

procedure TScriptPrintPreviewDlg.PrintCmdExecute(Sender: TObject);
begin
  SynEditPrintPreview.Print;
end;

procedure TScriptPrintPreviewDlg.CloseCmdExecute(Sender: TObject);
begin
  Close;
end;

procedure TScriptPrintPreviewDlg.Fitto1Click(Sender: TObject);
begin
...
procedure TScriptPrintPreviewDlg.ApplicationEvents1Hint(Sender: TObject);
begin
  StatusBar.Panels[0].Text := '  ' + Application.Hint;
end;

procedure TScriptPrintPreviewDlg.SynEditPrintPreviewMouseDown(
...
procedure TScriptPrintPreviewDlg.SynEditPrintPreviewPreviewPage(
  Sender: TObject; PageNumber: Integer);
begin
  StatusBar.Panels[1].Text := ' Page: ' + IntToStr(SynEditPrintPreview.PageNumber);
end;

procedure TScriptPrintPreviewDlg.FormCreate(Sender: TObject);
begin
  SynEditPrintPreview := TSynEditPrintPreview.Create(self);
  SynEditPrintPreview.Align := alClient;
  SynEditPrintPreview.ScaleMode := pscWholePage;
  SynEditPrintPreview.OnMouseDown := SynEditPrintPreviewMouseDown;
  SynEditPrintPreview.OnPreviewPage := SynEditPrintPreviewPreviewPage;
  SynEditPrintPreview.Parent := Self;
  SynEditPrintPreview.ScalePercent := 100;
end;
